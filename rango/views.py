...
def register(request):
    # Boolean indicates successful registeration (if true)
    registered = False
    ...
    if request.method == 'POST':
        ...
        # If userform and profileform are valid
...
# login_required ensures this only happens for users who are logged in
@login_required
